...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] songs = {R.raw.dheema, R.raw.ailasa, R.raw.sawadeeka};
    private String[] songTitles = {"Dheema", "Ailasa", "Sawadeeka"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton = findViewById(R.id.samp); // Updated to 'next' button ID
